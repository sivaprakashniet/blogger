"""
Starter fabfile for deploying the freefolks project.
...
# CHANGEME
env.hosts = ['user@freefolks.example.com']
env.code_dir = '/srv/www/freefolks'
env.project_dir = '/srv/www/freefolks/freefolks'
env.static_root = '/srv/www/freefolks/static/'
env.virtualenv = '/srv/www/freefolks/.virtualenv'
env.code_repo = 'git@github.com:user/freefolks.git'
env.django_settings_module = 'freefolks.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/freefolks/wsgi.py" % env.code_dir)
