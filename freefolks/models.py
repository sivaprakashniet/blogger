...
class Stockpiling(BaseModel):
	...
	stockpile_number = models.IntegerField(choices=NUMBERS, null=False, verbose_name="Stockpile number")
	amount_paid =  models.DecimalField(default=0.0, null=False, decimal_places=2, max_digits=12, verbose_name="Stockpile amount paid")
	grand_taken =  models.DecimalField(default=0.0, null=True,blank=True, decimal_places=2, max_digits=12, verbose_name="Stockpile amount taken")
