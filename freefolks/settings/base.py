...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'freefolks.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'freefolks.wsgi.application'
...
ADMINS = (
    ('SivaPrakash', 'sivaprakashniet@gmail.com'),
)
MANAGERS = ADMINS
...
SYSTEM_EMAIL_PREFIX = "[freefolks]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_freefolks"  # Make this unique to your project.
